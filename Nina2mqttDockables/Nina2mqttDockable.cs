...
public class Nina2mqttDockable : DockableVM, ITelescopeConsumer {
    private INighttimeCalculator nighttimeCalculator;
    private ITelescopeMediator telescopeMediator;

    [ImportingConstructor]
    public Nina2mqttDockable(
        ...
        dict.Source = new Uri("USARedDragon.NINA.Nina2mqtt;component/Nina2mqttDockables/Nina2mqttDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
        ImageGeometry = (System.Windows.Media.GeometryGroup)dict["USARedDragon.NINA.Nina2mqtt_AltitudeSVG"];
