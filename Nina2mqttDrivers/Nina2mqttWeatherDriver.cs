...
namespace USARedDragon.NINA.Nina2mqtt.Nina2mqttDrivers {
    ...
    /// </summary>
    public class Nina2mqttWeatherDriver : BaseINPC, IWeatherData {
    public Nina2mqttWeatherDriver(string uniqueId, string deviceId) {
        Id = uniqueId;
        serialNumber = deviceId;
        Name = $"Nina2mqtt Weather Data ({deviceId})";
    ...
    public string Category => "Nina2mqtt Weather Driver";
