...
public class Nina2mqttCondition : SequenceCondition {
    /// <summary>
    ...
    public override string ToString() {
        return $"Category: {Category}, Item: {nameof(Nina2mqttCondition)}, IsTruthy: {IsTruthy}";
    }
}
}