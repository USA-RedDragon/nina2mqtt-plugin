...
[ExportMetadata("Category", "nina2mqtt")]
[Export(typeof(ISequenceItem))]
[JsonObject(MemberSerialization.OptIn)]
public class Nina2mqttInstruction : SequenceItem {
    /// <summary>
    ...
    public Nina2mqttInstruction() {
        Text = Settings.Default.DefaultNotificationMessage;
    }
    public Nina2mqttInstruction(Nina2mqttInstruction copyMe) : this() {
        CopyMetaData(copyMe);
    }
    ...
    public override object Clone() {
        return new Nina2mqttInstruction(this);
    }
    ...
    public override string ToString() {
        return $"Category: {Category}, Item: {nameof(Nina2mqttInstruction)}, Text: {Text}";
    }
}
}